...
#define BIT_TEMPERATURE_OUT    	0x80
#define BIT_COMPASS_OUT    		0x01
...
#define DMP_IMAGE_SIZE           3062 //2639
...
struct inv_mpu_slave {
	...
	u8 (*read_reg)(struct inv_mpu_state *, u8 reg);
